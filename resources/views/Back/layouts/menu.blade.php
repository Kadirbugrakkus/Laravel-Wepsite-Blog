...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Admin Panels<sup>R</sup></div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link @if(Request::segment(2)=="icerikler") in @else collapsed @endif" href="#"
               data-toggle="collapse" data-target="#collapseTwo"
               aria-expanded="true" aria-controls="collapseTwo">
                <i class="fas fa-fw fa-edit"></i>
                <span>İçerikler</span>
            </a>
            <div id="collapseTwo" class="collapse @if(Request::segment(2)=="icerikler") show @endif"
                 aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">İçerik İşlemleri:</h6>
                    <a class="collapse-item @if(Request::segment(2)=="icerikler" and !Request::segment(3)) active @endif"
                       href="{{route('admin.icerikler.index')}}">Tüm İçerikler</a>
                    <a class="collapse-item @if(Request::segment(2)=="icerikler" and Request::segment(3)=="create") active @endif"
                       href="{{route('admin.icerikler.create')}}">İçerik Oluştur</a>
                </div>
            </div>
        </li>
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="{{asset('back/')}}/img/undraw_profile.svg"
                                         alt="...">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route('homepage')}}" target="_blank"
                       class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                        <i class="fas fa-globe fa-sm text-white-50"></i> Show Web Project</a>
                </div>
